...
const DescriptionSection = () => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-[40%_60%] gap-8 md:gap-4 w-[94%] mx-auto mt-12 mb-6'>
        <div className=''>
        ...
        <div className='bg-[#e9e9ed] rounded-t-lg'>
            <img src={gallery1} alt="custom hoodie" className='w-full h-[400px] object-cover rounded-lg'/>
        </div>
    </div>
  )
}
